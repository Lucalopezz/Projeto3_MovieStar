        ...
        <div class="row">
            <div class="col-md-6 offset-md-1">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" placeholder="Digite o Título do seu Filme" name="title" value="<?= $movie->title ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="length" placeholder="Digite a Duração do seu Filme" name="length" value="<?= $movie->length ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="trailer" placeholder="Insira o link do trailer" name="trailer" value="<?= $movie->trailer ?>">
                </div>

                <div class="form-group">
                    <label for="description">Descrição:</label>
                    <textarea name="description" id="description" placeholder="Descreva o Filme" rows="3" class="form-control"><?= $movie->description ?></textarea>
                </div>
